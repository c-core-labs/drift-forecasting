...
def forecast(obs: Observation, t1: np.datetime64, si_toggle=False):
    deg_radius = 10
    g = 9.80665
    rho_water = 1023.6
    rho_air = 1.225
    ...
    am = 0.5
    Re = 6371e3
    bathy_data_path = './bathymetry/gebco_2024_n60.0_s45.0_w-60.0_e-45.0.nc'
    ...
    return iceberg_times, iceberg_lats, iceberg_lons
