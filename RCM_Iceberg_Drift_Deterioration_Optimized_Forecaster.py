...
def rcm_iceberg_drift_deterioration_optimized_forecaster(obs: Observation, t1: np.datetime64, si_toggle, Ca_list, Cw_list, iceberg_u0_list, iceberg_v0_list):
    deg_radius = 5
    g = 9.80665
    rho_water = 1023.6
    rho_air = 1.225
    ...
    iceberg_u0_list = iceberg_u0_list if isinstance(iceberg_u0_list, list) else [iceberg_u0_list]
    iceberg_v0_list = iceberg_u0_list if isinstance(iceberg_v0_list, list) else [iceberg_v0_list]
    Ca_list = Ca_list if isinstance(Ca_list, list) else [Ca_list]
    Cw_list = Cw_list if isinstance(Cw_list, list) else [Cw_list]
    ...
    iceberg_us[0, :] = iceberg_u0_list
    iceberg_vs[0, :] = iceberg_v0_list
