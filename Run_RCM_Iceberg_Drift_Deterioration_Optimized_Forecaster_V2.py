...
shapefile_path = "C:/Users/idturnbull/Documents/MATLAB/ExxonMobil_RCM_Project_Analysis/20250403_132200_tracks/iceberg_optimized_forecast_output.shp"
...
rcm_datetime0_list = ['2025-04-03T13:22:00', '2025-04-03T13:31:00', '2025-04-03T13:10:00', '2025-04-03T13:09:00', '2025-04-03T13:09:00',
                      ...
                      '2025-04-03T13:31:00']
rcm_datetime0_list2 = ['2025-04-03T19:22:00', '2025-04-03T19:31:00', '2025-04-03T19:10:00', '2025-04-03T19:09:00', '2025-04-03T19:09:00',
                       '2025-04-03T19:14:00', '2025-04-03T19:14:00', '2025-04-03T19:31:00', '2025-04-03T19:31:00', '2025-04-03T19:25:00',
                       '2025-04-03T19:31:00', '2025-04-03T19:31:00', '2025-04-03T19:23:00', '2025-04-03T19:25:00', '2025-04-03T19:31:00',
                       '2025-04-03T19:31:00']
...
iceberg_lons0_list = [-48.9783, -49.8433, -48.6267, -48.6767, -48.1750, -49.0617, -49.5900, -49.9133, -50.0600, -50.1967, -50.2367, -50.1783, -50.2567, -50.2900,
                      -50.5917, -50.3900]
iceberg_lats0_list2 = [49.9709, 49.8338, 50.4904, 50.5706, 50.2621, 50.4449, 50.6480, 50.2261, 50.3320, 50.5076, 50.2043, 50.1460, 50.6128, 50.5304, 50.1792, 50.4272]
iceberg_lons0_list2 = [-48.9300, -49.8313, -48.5746, -48.6209, -48.1081, -49.0079, -49.4940, -49.9060, -50.0505, -50.1736, -50.2054, -50.1476, -50.2283, -50.2636,
                       -50.5374, -50.3590]
...
for m in range(len(rcm_datetime0_list)):
    ...
    iceberg_lats_end = iceberg_lats0_list2[m]
    iceberg_lons_end = iceberg_lons0_list2[m]
    rcm_datetime0 = np.datetime64(rcm_datetime0_list[m])
    next_rcm_time = np.datetime64(rcm_datetime0_list2[m])
    iceberg_lengths0 = 100.
    iceberg_lengths_end = 100.
    ...
    iceberg_pos_error_list, Ca_list, Cw_list, iceberg_u0_list, iceberg_v0_list = rcm_iceberg_drift_optimizer(iceberg_lats0, iceberg_lons0, iceberg_lengths0,
                                                                                                             iceberg_lats_end, iceberg_lons_end, iceberg_lengths_end,
                                                                                                             iceberg_ids, rcm_datetime0, next_rcm_time, si_toggle)
    iceberg_ids = iceberg_ids if isinstance(iceberg_ids, list) else [iceberg_ids]
    iceberg_lats0 = iceberg_lats0_list2[m]
    iceberg_lons0 = iceberg_lons0_list2[m]
    rcm_datetime0 = np.datetime64(rcm_datetime0_list2[m])
    ...
    iceberg_times, iceberg_lats, iceberg_lons, iceberg_lengths, iceberg_grounded_statuses = (
        rcm_iceberg_drift_deterioration_optimized_forecaster(obs, next_rcm_time, si_toggle, Ca_list, Cw_list,
                                                             iceberg_u0_list, iceberg_v0_list))
    iceberg_ids = iceberg_ids_list[m]
