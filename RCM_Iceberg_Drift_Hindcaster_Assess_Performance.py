...
def assess_rcm_iceberg_drift_hindcaster(iceberg_lat0, iceberg_lon0, rcm_datetime0, iceberg_length, grounded_status, previous_time,
    ...
    return (iceberg_lat0, iceberg_lon0, iceberg_lats, iceberg_lons, iceberg_times, iceberg_length,
            iceberg_draft, iceberg_mass, rcm_datetime0, previous_time, grounded_status, iceberg_lengths, iceberg_masses, iceberg_siconcs)
...
output_filepath = 'C:/Users/idturnbull/Documents/MATLAB/ExxonMobil_RCM_Project_Analysis/RCM_Iceberg_Hindcaster_Results/'
...
for p in range(len(rcm_shapefiles_names_2023)):
    ...
    sorted_indices = np.argsort(acqdates)[::-1]
    ...
    for m in range(len(sorted_indices) - 1):
        try:
            ...
            (iceberg_lat0, iceberg_lon0, iceberg_lats, iceberg_lons, iceberg_times, iceberg_length,
             iceberg_draft, iceberg_mass, rcm_datetime0, previous_time, grounded_status, iceberg_lengths, iceberg_masses, iceberg_siconcs) = (
                assess_rcm_iceberg_drift_hindcaster(iceberg_lat0, iceberg_lon0, rcm_datetime0, iceberg_length, grounded_status, previous_time,
            ...
            previous_time = datetime64_to_datenum(previous_time)
            savemat(output_filepath + rcm_shapefile[:-4] + '_' + str(m + 1) + '.mat', {'iceberg_times': iceberg_times, 'iceberg_lat0': iceberg_lat0,
                                                                                                 ...
                                                                                                 'previous_time': previous_time, 'iceberg_lats': iceberg_lats,
